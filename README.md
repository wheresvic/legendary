...
1. [React 16 migration engineering](https://code.facebook.com/posts/1716776591680069/react-16-a-look-inside-an-api-compatible-rewrite-of-our-frontend-ui-library/), brilliant take on migration engineering, illustrates the use of:
  1. feature toggles to reduce merge conflicts
  1. TDD for api coverage
  1. regression logging for faster feedback loop
  1. coverage chart for motivation
  1. staggered rollout and A/B testing with an eye on product metrics for migration issues
...
1. [Strategy Letter V - Joel Spolsky](https://www.joelonsoftware.com/2002/06/12/strategy-letter-v/), Micro economics 101, try to commoditize your products complement so that the demand for your product goes up:
  1. Microsoft makes a free browser so that more people by it's operating system,
  1. Google makes software so that more people rely on it to feed it information which it can use for better search results which leads to them getting the lions share of advertising money (this example was added by me)
  1. Note that it is easier for software to commoditize hardware than the other way around
